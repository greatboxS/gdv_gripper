...
//   <i> Default: 200
 ...
 #define OS_MAINSTKSIZE 762      // this stack size value is in words
#endif
...
//   <i> Default: 0
 ...
 #define OS_PRIVSTKSIZE 1018       // this stack size value is in words
#endif
...
void os_error (uint32_t error_code) {
  ...
  switch (error_code) {
    case OS_ERROR_STACK_OVF:
		send_debugging_data("OS_ERROR_STACK_OVF");
      /* Stack overflow detected for the currently running task. */
      /* Thread can be identified by calling svcThreadGetId().   */
      break;
    case OS_ERROR_FIFO_OVF:
		send_debugging_data("OS_ERROR_FIFO_OVF");
      /* ISR FIFO Queue buffer overflow detected. */
      break;
    case OS_ERROR_MBX_OVF:
		send_debugging_data("OS_ERROR_MBX_OVF");
      /* Mailbox overflow detected. */
      break;
    case OS_ERROR_TIMER_OVF:
		send_debugging_data("OS_ERROR_TIMER_OVF");
